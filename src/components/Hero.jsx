    ...
    >
      ...
      >
        ...
        <div className="flex flex-row items-center justify-between w-full ">
          <h1 className="flex-1 font-poppins font-semibold ss:text-7xl text-[52px] text-white ss:leading-[100px]">
      ...
      <div className={`flex-1 flex ${style.flexStart} md:my-0 my-10 relative`}>
        <img
          src={robot}
          alt="Billing"
